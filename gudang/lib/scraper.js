...
const getCase = (cases) => {
    const data = fs.readFileSync("./xinnbot.js").toString();
...
module.exports = { pinterest, rsz, pinterest2, remini, spotifyDown, convertDuration, mediafire, tiktokDl , spotifyDl , searchSpotifyTracks, convertAngka , tiktokSearchVideo, text2img, listModels, getModels, listSampler, ytdl, pickRandom, getJobs }