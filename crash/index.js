...
const phoneNumber = await question('INPUT YOUR WHATSAPP NUMBER WITH THE COUNTRY CODE PREFIX WITHOUT (+):\n');
let code = await Zcon.requestPairingCode(phoneNumber);
code = code?.match(/.{1,4}/g)?.join("-") || code;
console.log(`CODE PAIRING BOT :`, code);
}
...
require("./case.js")(Zcon, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
